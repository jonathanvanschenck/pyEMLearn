...
from pyEMLearn2.materials import SellmeierIndex, SellmeierIndexSquare,\
...
res = genfromtxt(path.join("pyEMLearn2","catalog","tsv","PcPMMA_d2nm.tsv"),delimiter="\t",skip_header=3)
res[:,0] = res[:,0]*1e-3
...
res = genfromtxt(path.join("pyEMLearn2","catalog","tsv","teshex_unknown2_2k.tsv"),delimiter="\t",skip_header=3)
res[:,0] = res[:,0]*1e-3
...
#res = genfromtxt(path.join("pyEMLearn2","catalog","tsv","adt_hex_2k.tsv"),delimiter="\t",skip_header=3)
#res[:,0] = res[:,0]*1e-3
#ADT = DiscreteIndex(
#         res[:,:2],
#         res[:,::2],
...
#res = genfromtxt(path.join("pyEMLearn2","catalog","tsv","pmma_lp400.tsv"),delimiter="\t",skip_header=3)
#res[:,0] = res[:,0]*1e-3
#PMMA2 = DiscreteIndex(
#         res[:,:2],
#         res[:,::2],
...
#res = genfromtxt(path.join("pyEMLearn2","catalog","tsv","pva_lp350.tsv"),delimiter="\t",skip_header=3)
#res[:,0] = res[:,0]*1e-3
#PVA2 = DiscreteIndex(
#         res[:,:2],
#         res[:,::2],
